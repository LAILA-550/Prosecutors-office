...
$case = $conn->query("SELECT cases.case_number, cases.defendant, cases.description, cases.status, 
  ...
  <div class="container-fluid h-100">
    <div class="row h-100">
      ...
      <main class="col-md-12 ms-sm-auto col-lg-12 px-md-4">
        ...
        <div class="mb-3">
          <a href="/laila1/admin" class="btn btn-secondary">العودة إلى القضايا</a>
        </div>
