...
logUserAction($user_id, "زيارة صفحة القضايا", "cases.php", "نجاح");
...
$cases = $conn->query("SELECT cases.id, cases.case_number, cases.defendant, cases.description, cases.status, 
                       ...
                       WHERE cases.prosecutor_id = $user_id
                       AND (cases.case_number LIKE '%$search_query%' OR cases.defendant LIKE '%$search_query%')");

if (!$cases) {
  logUserAction($user_id, "فشل في جلب القضايا", "cases.php", "فشل");
}
?>
    ...
    <div class="row h-100">
      ...
      <main class="col-md-12 ms-sm-auto col-lg-12 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">قضاياي</h1>
          <?php include '_navbar_contents.php' ?>
        </div>


        <form method="GET" action="cases.php" class="mb-3">
